...
public class SGD285_1
{
    ...
    public static void Main()
    {
	    ...
	    new UserQuote("Ryan Douglass", "If there is no struggle there is no progress. - Frederick Douglass"), /*By Jennifer Ethridge: I can totally relate to this quote right now, because I am struggling with this assignment.*/		
            new UserQuote("Baylen Smith", "Whatever happens, happens. - Spike Spiegel"), /*By Jennifer Ethridge: I never really got into Cowboy Bebop.*/
	    new UserQuote("Jennifer Ethridge", "If I have found a desire within myself that no experience in this world can satisfy; the most probable explanation is that I was made for another world.")
